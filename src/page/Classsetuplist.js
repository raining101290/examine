...
function Classsetuplist(props) {
    ...
    const fetchData = async (pageNumber = 1) => {
        ...
        console.log(base.BASE_URL + '/classlist/' + pageNumber + '/5')
        const api = await fetch(base.BASE_URL + '/classlist/' + pageNumber + '/50');
    ...
    const deleteEmployee = (id) => {
        ...
        if (answer) {
            ...
            axios.post(base.BASE_URL + '/delete_class', {
                id: id
                },{
                    headers: {
    ...
    return (
        <div>
                  ...
                  <div className="input-group">
                    <input type="text" className="form-control bg-light border-0 small" placeholder="Search by School/College Name." 
                      ...
                      <button className="btn btn-primary" type="button">
                        Search
                                        ...
                                        <div className='thirdcolumn'>
                                            <Link to="/Classsetup" className='btn btn-primary'
                                ...
                                https://github.com/coderspirit-git/React-js-Pagination/blob/main/src/App.js
                                */}
                                            ...
                                            state?.users ?
                                                state?.users?.map((result) => (
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{result.xclassname}</td>
                                                        <td>
                                                        <Link variant="info" to={"/Editsubjectsetup/" + result._id}>Edit</Link>
                                                        </td>
                                                        <td>
