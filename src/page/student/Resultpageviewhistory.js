...
import Acurraytranscript from './Acurraytranscript';
...
const Resultpageviewhistory = (props) => {
    const history = useHistory();
    let subtitle;
    const [modalIsOpen, setIsOpen] = React.useState(false);
    const [examdb, setExamdb] = useState([]);
    const [studentid, setStudentid] = useState(localStorage.getItem('studentid'));
    const [examrandomid, setExamrandomid] = useState('');
    ...
    const getData = () => {
        ...
        axios.get(base.BASE_URL + '/getquizserial/' + examid, {
            headers: {
    ...
    const getallquestionshow = async (pageNumber = 1) => {
        console.log(base.BASE_URL + '/resultpageviewhistory/' + examid + '/' + studentid);
        const api = await fetch(base.BASE_URL + '/resultpageviewhistory/' + examid + '/' + studentid);
        ...
        <div className='resultpage'>
            <div className='me'>
                <div style={{
                    ...
                    <Link to={"/Studentdashboard"} className='resultback'>Back</Link>
                            ...
                            <p>Result Details</p>
                            {
                                ...
                                state?.users ?
                                    state?.users?.map((result, index) => (
                                        ...
                                        <div class="card position-relative" style={{ marginBottom: 10 }} key={index}>
                                                                ...
                                                                <td colSpan={2}>
                                                                    <div style={{ display: 'flex', alignContent: 'space-between' }}>
                                                                        <div style={{ color: 'green', marginRight: 5 }}>
                                                                            ...
                                                                            Your Answer:  {Parser(result.useranswer)}
                                                                        </div>
...
export default Resultpageviewhistory;
