...
import { faCoffee, faClose, faMusic, faRegistered, faHandsHolding, faSave } from '@fortawesome/free-solid-svg-icons'
...
///////////////////////////////////////////////////////
                ...
                axios.get(base.BASE_URL + '/updateexamasfinish/' + examid + '/' + studentid, {
                headers: {
                authorization: `bearer ${localStorage.getItem('token')}`
                }
                }).then(res => {
...
///////////////////////////////////////////////////////
    ...
    const getid = (A) => {
        if (quiztype == 'MCQ') {
            ...
            axios.post(base.BASE_URL + '/playingquizinsert', {
                quizid: obid,
    ...
    const insertmatchfirst = (answerid) => {
        // alert(answerid)
        axios.post(base.BASE_URL + '/insertMatch', { //insertmatchfirst
            answerid: answerid,
            studentid: studentid,
            examid: examid,
            quizid: obid,
    ...
    const insertMatch = () => {
        setIsloading(true)
        axios.post(base.BASE_URL + '/insertmatchfirst', {
            studentid: studentid,
            examid: examid,
            quizid: obid,
            examrandomid: localStorage.getItem('examrandomid')
    ...
    const insertqestionMCQ = (A, correct) => {
        ...
        axios.post(base.BASE_URL + '/playinsertmcq', {
            quizid: obid,
            useranswer: A,
            studentid: studentid,
            examid: examid,
    ...
    const insertqestion_fillinthegaps = (choseanswer, e) => {
        //  alert(choseanswer);
        axios.post(base.BASE_URL + '/playinsertfillinthegap', {
            quizid: obid,
    ...
    const fileSelectA = event => {
        if (obid == "") {
            ...
            axios.post(base.BASE_URL + '/Aimageupload_useranswerfileupload', fd
            ).then(res => {
                // alert(res.message);
                if (res.status == '200') {
                ...
                <Row style={{ marginBottom: 10 }}>
                    <Col xs={6} sm={4}>
                        <div className='headerquizleft'>
                            <Link to={"/Startquizsaveexits/" + examid + '/' + serialid + '/' + totalquiz} title="save and Exit">
                                <FontAwesomeIcon icon={faSave} style={{ color: 'white', fontSize: 28, }}></FontAwesomeIcon>

                            </Link>
                        </div>
                        <div className='headerquizleft'>
                            <Link to="">
                                <FontAwesomeIcon icon={faMusic} style={{ color: 'white', fontSize: 24, marginTop: 3, marginLeft: -5 }}>
                        ...
                        <div className='headerquizleft'>
                            <p style={{ fontSize: 10 }}>{serialid} / {totalquiz}</p>
                        </div>
                    ...
                    <Col xs={4} sm={4}>
                        ...
                        <div className='headerquiztime' onClick={Nextbtn}>
                            <p style={{ fontSize: 16, textAlign: 'center' }}> Next {/* {minutes}:{seconds}  */}  </p>
                        </div>

                    </Col>
                    <Col xs={2} sm={4}>
                        <div className='headerquizright'>
                            <Link to={"/Startquizsaveexits/" + examid + '/' + serialid + '/' + totalquiz} title="Close">
                                ...
                                <div className='mcqexampage_divsecond'>
                                                    ...
                                                    <div style={{ justifyContent: 'center', alignItems: 'center', width: '100%', display: 'flex' }}>
                                                        <table style={{ width: '100%', padding: 20 }}>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p style={{ color: '#ffffff' }}> select the right answer with column A </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <select
                                                                        style={{ padding: 6, backgroundColor: '#f2f2f2', fontSize: 10 }}
                                                                        className="form-control"
                                                                        onChange={(e) => {

                                                                            setRightone(e.target.value)
                                                                        }}>
                                                                        <option value="">Select Match with Column A</option>
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <Button onClick={insertMatch} style={{ marginTop: 40 }}>Submit</Button>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <div className='writtingtext'>
                                                        ...
                                                        <div style={{ marginBottom: 10, display: 'flex' }}>
                                                            <ReactQuill modules={modules} theme="snow"
                                                                placeholder=""
                                                                style={{ width: '100%', fontSize: 12, color: '#ffffff' }}
                                                        ...
                                                        <Button onClick={playfillinthegap} style={{ marginTop: 40 }}>Submit</Button>
                                                    </div>
                                                </Col>
                                            </Row>
                                            :
                                                        ...
                                                        <Row>
                                                            <Col xs={12} sm={12} style={{
                                                                ...
                                                                <div className='writtingtext'
                                                                    ...
                                                                    <Button onClick={playwrittingtest} style={{ marginTop: 40 }}>Submit</Button>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                        :
                                                        ...
                                                        <div style={{
                                                            ...
                                                            <div style={{ width: 250, textAlign: 'center' }}>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <input type="file" onChange={fileSelectA} className='form-control'
                                                                                style={{
                                                                                    marginTop: 50
                                                                                }} />
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <Button onClick={playwrittingtestimage} style={{ marginTop: 20 }}>Submit </Button>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                    ...
                                    }
                                    {
                                        quiztype == 'MCQ' ?
                                            <Row>
                                                <Col xs={6} sm={3}>
                                                    <Link to="#" onClick={playA} style={{ color: '#ffffff', textDecoration: 'none' }}>
                                                        <div className='playA text-center'>
                                                            ...
                                                            }
                                                            {
                                                                result.Atype == 'Image and Text' ?
                                                                    <img src={base.BASE_URL + result.Aimage} style={{ width: '100%', height: '100%' }} />
                                                                    :
                                                                    ''
                                                            }
                                                            {
                                                ...
                                                <Col xs={6} sm={3}>
                                                    <Link to="#" onClick={playB} style={{ color: '#ffffff', textDecoration: 'none' }}>
                                                        <div className='playB'>
                                                            ...
                                                            }
                                                            {
                                                                result.Btype == 'Image and Text' ?
                                                                    <img src={base.BASE_URL + result.Bimage} style={{ width: '100%', height: '100%' }} />
                                                                    :
                                                                    ''
                                                            }
                                                            {
                                                ...
                                                <Col xs={6} sm={3}>
                                                    <Link to="#" onClick={playC} style={{ color: '#ffffff', textDecoration: 'none' }}>
                                                        <div className='playC'>
                                                            ...
                                                            }
                                                            {
                                                                result.Ctype == 'Image and Text' ?
                                                                    <img src={base.BASE_URL + result.Cimage} style={{ width: '100%', height: '100%' }} />
                                                                    :
                                                                    ''
                                                            }
                                                            {
                                                ...
                                                <Col xs={6} sm={3}>
                                                    <Link to="#" onClick={playD} style={{ color: '#ffffff', textDecoration: 'none' }}>
                                                        <div className='playD'>
                                                            ...
                                                            }
                                                            {
                                                                result.Dtype == 'Image and Text' ?
                                                                    <img src={base.BASE_URL + result.Dimage} style={{ width: '100%', height: '100%' }} />
                                                                    :
                                                                    ''
                                                            }
                                                            {
                ...
                >
                    {
                        studentchoose == 'correct' ?
                            <div style={{ height: 300, width: 300 }}>
                                <div className='correctanswer'><p>Correct Answer</p></div>
                            </div>
