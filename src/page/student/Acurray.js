...
export class Acurray extends Component {
    ...
    getData = () => {
        console.log(base.BASE_URL + '/correctanswer/' + this.state.examrandomid)
        axios.get(base.BASE_URL + '/correctanswer/' + this.state.examrandomid, {
            headers: {
    ...
    getDatatwo = () => {
        console.log(base.BASE_URL + '/incorrectanswer/' + this.state.examrandomid)
        axios.get(base.BASE_URL + '/incorrectanswer/' + this.state.examrandomid, {
            headers: {
                authorization: `bearer ${localStorage.getItem('token')}`
            }
        }).then(res => {
