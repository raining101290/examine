                                        ...
                                        <div>
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="form-holder col-md-6" style={{ padding: 10 }}>
                                                    ...
                                                    >
                                                        <option value={localStorage.getItem('schoolcollegetype')}>{localStorage.getItem('schoolcollegetype')}</option>
                                                ...
                                                <div className="form-holder col-md-6" style={{ padding: 10 }}>
                                                    ...
                                                    <select className="combox"  onChange={this.handleschoolcollagename}>
                                                        <option value={this.state.schoolid}>{this.state.schoolcollegename}</option>
