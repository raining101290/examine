...
export class Sectionsetup extends Component {
    ...
    handleinstutename(event) {
        this.setState({
            inistutename: event.target.value
        })
    ...
    register() {
        ...
        if (this.state.inistutetype == "" || this.state.schoolname == "" || this.state.name == "" || this.state.schoolid == "") {
            ...
            axios.post(base.BASE_URL + '/sectionsetup', {
    ...
    render() {
        ...
        if (this.state.loggdin == 'start') {
            return <Redirect to="/Sectionsetuplist" />
        }
                                                        ...
                                                        <div class="form-content">
                                                            <div>
                                                                <div className="form-header">
                                                                    <h3 class="m-0 font-weight-bold text-primary">Section Setup</h3>
                                                                </div>
