...
export class Classsetup extends Component {
    ...
    register() {
        ...
        if (this.state.inistutetype == "" || this.state.schoolname == "" || this.state.name == "" || this.state.schoolid == "") {
            ...
            axios.post(base.BASE_URL + '/classsetup', {
    ...
    render() {
        ...
        if (this.state.loggdin == 'start') {
            return <Redirect to="/Classsetuplist" />
        }
                                                        ...
                                                        <div class="form-content">
                                                            <div>
                                                                <div className="form-header">
                                                                    <h3 class="m-0 font-weight-bold text-primary">Class Setup</h3>
                                                                </div>
