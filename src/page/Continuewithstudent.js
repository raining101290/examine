...
export class Continuewithstudent extends Component {
  ...
  register() {
    if (this.handleValidation()) {
      ...
      if (
        this.state.fields['password'] !== this.state.fields['reentrypassword']
      ) {
        ...
        axios
          .post(base.BASE_URL + '/signupstudent', {
...
International: {this.state.mobileno && formatPhoneNumberIntl(this.state.mobileno)} */}
                            ...
                            <div className="form-group">
                              ...
                              <Input
                                type={
                                  this.state.showpassordfirsttxt
                                    ? 'text'
                                    : 'password'
                                }
                            ...
                            <div className="form-group">
                              <Input
                                type={
                                  this.state.showpasswordsecondtxt
                                    ? 'text'
                                    : 'password'
                                }
                                onChange={this.handleChange.bind(
                                ...
                                value={this.state.fields['reentrypassword']}
                                className="form-control "
                              ...
                              <span style={{ color: 'red', fontSize: 10 }}>
                                {this.state.errors['reentrypassword']}
                              </span>
                            </div>
                          ...
                          <hr />
                          <div className="text-center">
                            <Link className="small" to="/Studentlogin">
