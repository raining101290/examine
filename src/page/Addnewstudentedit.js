...
export class Addnewstudentedit extends Component {
    ...
    componentDidMount() {
        ...
        if (this.state.userrole == "Admin") {
            ...
            axios.get(base.BASE_URL + '/getsectionid/' + this.state.schoolid)
               ...
               // console.log(base.BASE_URL + '/studentinfosingle/' + this.props.match.params.id)          
                axios.get(base.BASE_URL + '/studentinfosingle/' + this.props.match.params.id, {
                    headers: {
    ...
    createuser() {
        if (this.handleValidation()) {
            ...
            axios.post(base.BASE_URL + '/updatestudentinformation', {
                                                            ...
                                                            <div>
                                                                <div className="form-header">
                                                                    ...
                                                                    <h3 class="m-0 font-weight-bold text-primary"
                                                                        style={{ fontSize: 16 }}>Edit Student Page</h3>
                                                                </div>
                                                                <div className="form-row">
                                                                    ...
                                                                    placeholder="Student ID"
                                                                            ...
                                                                            value={this.state.studentid} readOnly />
...
export default Addnewstudentedit
