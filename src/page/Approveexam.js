...
import Approveexamdetails from './datapagination/Approveexamdetails';
...
export class Approveexam extends Component {
                ...
                <Container style={{ marginTop: 86 }}>
                    <Row >
                        <Col xs={6} sm={8} style={{ alignContent: 'space-between' }}>
                          <p style={{ padding: 10 }}>Waiting for Approve Exam </p> 
