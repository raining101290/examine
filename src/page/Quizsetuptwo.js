...
export class Quizsetuptwo extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      examname: this.props.match.params.id,
      questiontype: '',
  ...
  handlestate(event) {
    ...
    axios
      .get(
        base.BASE_URL +
          '/getparmetersubjectlist/' +
          this.state.schoolcollegetype +
          '/' +
          event.target.value,
      )
      .then((result) => {
        this.setState({
          schoolcollegesubjectlist: result.data,
          automemberid: result.data[0].status,
        })
      })
    ///////////////////////////////
  }
  ...
  fileSelectquestionimage = (event) => {
    if (this.state.questiontype === '' || this.state.automemberid === '') {
      ...
      this.setState({
        ...
        questionimageupload_loader: true,
      })
      ...
      //console.log('vaipar', url) // Would see a path?
      // end image previou
      //////////upload
      const options = {
      ...
      axios
        ...
        .then((res) => {
          if (res.status === 200) {
            this.setState(
              { questionimageupload_loader: false, uploadPercentage: 100 },
              () => {
                setTimeout(() => {
  ...
  fileSelectA = (event) => {
    if (this.state.Atype == '' || this.state.automemberid == '') {
      ...
      ////////////////////////////////////////
      this.setState({
        questionAimage: event.target.files[0],
        questionimageupload_loader: true,
      })
      console.log(event.target.files[0])
      // image preview
  ...
  fileSelectB = (event) => {
    if (this.state.Btype == '' || this.state.automemberid == '') {
      ...
      ////////////////////////////////////////
      this.setState({
        questionBimage: event.target.files[0],
        questionimageupload_loader: true,
      })
      console.log(event.target.files[0])
      // image preview
  ...
  fileSelectC = (event) => {
    if (this.state.Ctype == '' || this.state.automemberid == '') {
      ...
      ////////////////////////////////////////
      this.setState({
        questionCimage: event.target.files[0],
        questionimageupload_loader: true,
      })
      console.log(event.target.files[0])
      // image preview
  ...
  fileSelectD = (event) => {
    if (this.state.Dtype == '' || this.state.automemberid == '') {
      ...
      ////////////////////////////////////////
      this.setState({
        questionDimage: event.target.files[0],
        questionimageupload_loader: true,
      })
      console.log(event.target.files[0])
      // image preview
              ...
              <div class="card-header py-3">
                <div className="form-header">
                  <h3 class="m-0 font-weight-bold text-primary">
                    Quiz Details {/* - Quiz ID: {this.state.automemberid} */}
                  </h3>
                </div>
                            ...
                            >
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  onClick={this.handleClickQuestionimage.bind(
                                    this,
                                  )}
                                >
                                  <IconButton
                                ...
                                <input
                                  id="questionfile"
                                  type="file"
                                  onChange={this.fileSelectquestionimage.bind(
                                    this,
                                  )}
                                  accept="image/*"
                                  className="form-control"
                              ...
                              <div
                                className="form-holder col-md-9"
                                style={{
                                  padding: 10,
                                  borderWeight: 1,
                                  borderColor: 'silver',
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                      ...
                                      >
                                        <div>
                                          ...
                                          />{' '}
                                          {/*  display: 'none'  x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}    */}{' '}
                                        </div>
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose2}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose3}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                      ...
                                      >
                                        ...
                                        <div style={{ marginTop: 0 }}>
                                          <Basicthree
                                            setTextthree={this.setTextthree}
                                          />
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose4}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose5}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose6}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose7}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                      ...
                                      >
                                        ...
                                        <div style={{ marginTop: 0 }}>
                                          <Basicseven
                                            setTextseven={this.setTextseven}
                                          />
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose8}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                                      ...
                                      >
                                        ...
                                        <div style={{ marginTop: 0 }}>
                                          <Basiceight
                                            setTexteight={this.setTexteight}
                                          />
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  >
                                    <div style={{ width: '100%', height: 400 }}>
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={this.handlemathpopupClose9}
                                          style={{
                                            textAlign: 'right',
                                            border: 'none',
                                          }}
                              ...
                              >
                                  ...
                                  <div>
                                    ...
                                    {this.state.Atype === 'Image' ? (
                                      <Button
                                        ...
                                        onClick={this.handleClickAimage.bind(
                                          this,
                                        )}
                                      >
                                        <ImageIcon />
                                ...
                                >
                                  {this.state.Atype === 'Math' ? (
                                    ...
                                    <textarea
                                      onChange={(e) =>
                                        this.setState({ text6: e.target.value })
                                      }
                                      value={this.state.text6}
                              ...
                              >
                                  ...
                                  <div>
                                    ...
                                    {this.state.Btype === 'Image' ? (
                                      <Button
                                        ...
                                        onClick={this.handleClickBimage.bind(
                                          this,
                                        )}
                                      >
                                        <ImageIcon />
                                    ...
                                    <input
                                      type="file"
                                      onChange={this.fileSelectB}
                                      className="form-control"
                                      ref={this.inputReferenceB}
                                      hidden
                                    />{' '}
                                  </div>
                                  <div>
                                ...
                                >
                                  {this.state.Btype === 'Math' ? (
                                    ...
                                    <textarea
                                      onChange={(e) =>
                                        this.setState({ text7: e.target.value })
                                      }
                                      value={this.state.text7}
                                      style={{ width: '100%', height: 130 }}
                                    />
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div>
                                    {this.state.Ctype === 'Image' ? (
                                      <div>
                                        <Button
                                          ...
                                          onClick={this.handleClickCimage.bind(
                                            this,
                                          )}
                                        >
                                          <ImageIcon />
                                    ...
                                    <input
                                      type="file"
                                      onChange={this.fileSelectC}
                                      className="form-control"
                                      ref={this.inputReferenceC}
                                      hidden
                                    />
                                  </div>
                                  <div>
                                ...
                                >
                                  {this.state.Ctype === 'Math' ? (
                                    ...
                                    <textarea
                                      onChange={(e) =>
                                        this.setState({ text8: e.target.value })
                                      }
                                      value={this.state.text8}
                                      style={{ width: '100%', height: 130 }}
                                    />
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <input
                                      type="file"
                                      onChange={this.fileSelectD}
                                      className="form-control"
                                      ref={this.inputReferenceD}
                                      hidden
                                    />
                                  </div>
                                  ...
                                  <div>
                                    {this.state.Dtype == 'Image' ? (
                                      <Button
                                        ...
                                        onClick={this.handleClickDimage.bind(
                                          this,
                                        )}
                                      >
                                        <ImageIcon />
                                ...
                                >
                                  {this.state.Dtype == 'Math' ? (
                                    ...
                                    <textarea
                                      onChange={(e) =>
                                        this.setState({ text9: e.target.value })
                                      }
                                      value={this.state.text9}
                                      style={{ width: '100%', height: 130 }}
                                    />
                          ...
                          <div className="form-row">
                            ...
                            >
                              ...
                              <input
                                ...
                                onChange={this.handlewrittinganswer}
                              />
                            </div>
                          </div>
                        </div>
