...
export class Writtingtest extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showmathpopup: false,
      mathchange: '',
      textvalue: '\\frac{1}{\\sqrt{2}}\\cdot 2',
      text: '',
      titletypetext1: 'Text',
      titletypetext2: 'Text',
      titletypetext3: 'Text',
  ...
  register() {
    ...
    if (
      ...
      axios
        .post(
          base.BASE_URL + '/writtingtestupdate',
          {
              ...
              <div class="">
                <div className="form-header">
                  <h3
                    ...
                    style={{ fontSize: 16 }}
                  >
                    Writting Test Upload{' '}
                    {/* - Quiz ID: {this.state.automemberid} */}
                  </h3>
                </div>
                          ...
                          <div className="form-row">
                            ...
                            >
                              ...
                              <input
                                ...
                                onChange={this.handlequestiontime}
                              />
                            </div>
                            ...
                            >
                              ...
                              <input
                                type="file"
                                onChange={this.fileSelectquestionimage}
                                className="form-control"
                                style={{ marginTop: 12 }}
                              />
                            </div>
                            ...
                            >
                              ...
                              <select
                                onChange={this.handleanswertype}
                                style={{
                                  padding: 6,
                                  backgroundColor: '#f2f2f2',
                                }}
                              ...
                              <table style={{ width: '100%' }}>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <textarea
                                      onChange={(e) =>
                                        this.setState({ text5: e.target.value })
                                      }
