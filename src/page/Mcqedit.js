...
export class Mcqedit extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            editorHtmlA: '',
            editorHtmlB: '', editorHtmlC: '', editorHtmlD: '', showmathpopup: false, handlemathpopupClose: false, textequation: '',
            ...
            text6: '',text7: '',text8: '',text9: '',text:'',showmathpopup6:false, showmathpopup7: false, showmathpopup8: false
    ...
    componentDidMount() {
        console.log(base.BASE_URL + '/quizedit/' + this.state.automemberid)
        axios.get(base.BASE_URL + '/quizedit/' + this.state.automemberid, {
            ...
            if (res.data.length > 0) {
                ...
                this.setState({
                    ...
                    editorHtmlA: res.data[0].Atitle,
                    editorHtmlB: res.data[0].Btitle,
                    editorHtmlC: res.data[0].Ctitle,
                    editorHtmlD: res.data[0].Dtitle,
                    ...
                    text6: res.data[0].Atitle,
                    text7: res.data[0].Btitle,
                    text8: res.data[0].Ctitle,
                    text9: res.data[0].Dtitle,
    ...
    register() {
        ...
        else if(this.state.text6 == "" || this.state.text7 == "" || this.state.text8 == "" || this.state.text9 == "")
        {
            alert('Select Section A,B,C,D')
        }
        else {
            ...
            axios.post(base.BASE_URL + '/mcqquestionupdate', {
                        ...
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <div className="form-header">
                                    <h3 class="m-0" style={{ fontSize: 14 }}>Edit MCQ Quiz Details {/* - Quiz ID: {this.state.automemberid} */}</h3>
                                </div>
                                                    ...
                                                    <div className="form-row">
                                                        <div style={{
                                                            ...
                                                            <div className="form-holder col-md-2" style={{ padding: 10 }}>
                                                                ...
                                                                >
                                                                    <option value={this.state.questiontype}> {this.state.questiontype}</option>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                    <div>
                                                                        <select onChange={this.handleAtype}
                                                                            ...
                                                                            className="form-control"
                                                                        >
                                                                            <option value={this.state.Atype}>{this.state.Atype}</option>
                                                                            <option value="Math">Math</option>
                                                                            <option value="Text">Text</option>
                                                                            <option value="Image">Image</option>
                                                                            <option value="Image and Text">Image and Text</option>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {/* <img src={this.state.previewA} style={{ width: 50, height: 50 }} />  */}
                                                                        {
                                                                            ...
                                                                            <img src={base.BASE_URL + this.state.Aimage}
                                                                                style={{ width: 50, height: 50 }}
                                                                            />
                                                                        }
                                                                    </div>
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                    <div>
                                                                        <select onChange={this.handleBtype}
                                                                            ...
                                                                            className="form-control"
                                                                        >
                                                                            <option value={this.state.Btype}>{this.state.Btype}</option>
                                                                            <option value="Math">Math</option>
                                                                            <option value="Text">Text</option>
                                                                            <option value="Image">Image</option>
                                                                            <option value="Image and Text">Image and Text</option>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {
                                                                            this.state.Bimage ?
                                                                                <img src={base.BASE_URL + this.state.Bimage}
                                                                                    style={{ width: 50, height: 50 }}
                                                                                />
                                                                                :
                                                                                ''
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                    <div>
                                                                        <select onChange={this.handleCtype}
                                                                            ...
                                                                            className="form-control"
                                                                        >
                                                                            <option value={this.state.Ctype}>{this.state.Ctype}</option>
                                                                            <option value="Math">Math</option>
                                                                            <option value="Text">Text</option>
                                                                            <option value="Image">Image</option>
                                                                            <option value="Image and Text">Image and Text</option>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {
                                                                            this.state.Cimage ?
                                                                                <img src={base.BASE_URL + this.state.Cimage}
                                                                                    style={{ width: 50, height: 50 }}
                                                                                />
                                                                                :
                                                                                ''
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                                    <div>
                                                                        <select onChange={this.handleDtype}
                                                                            ...
                                                                            className="form-control"
                                                                        >
                                                                            <option value={this.state.Dtype}>{this.state.Dtype}</option>
                                                                            <option value="Math">Math</option>
                                                                            <option value="Text">Text</option>
                                                                            <option value="Image">Image</option>
                                                                            <option value="Image and Text">Image and Text</option>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {
                                                                            this.state.Dimage ?
                                                                                <img src={base.BASE_URL + this.state.Dimage}
                                                                                    style={{ width: 50, height: 50 }}
                                                                                />
                                                                                :
                                                                                ''
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-holder col-md-3" style={{ padding: 10 }}>
                                                            ...
                                                            <select onChange={this.handleAnswer}
                                                                style={{ padding: 6, backgroundColor: '#f2f2f2' }}
                                                                className="form-control">
                                                                <option value={this.state.Answer}>{this.state.Answer}</option>
